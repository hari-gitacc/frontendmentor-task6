...
const Home = () => {
  ...
  return (
    <section className='text-white flex-col  tablet:flex-row items-center flex h-[100vh]'>
        ...
        <p className='font-primary text-center tablet:text-left '>Let’s face it; if you want to go to space, you might as well genuinely go to outer space and not hover kind of on the edge of it. Well sit back, and relax because we’ll give you a truly out of this world experience!</p>
        </div>
      ...
      <button className='font-secondary tablet:mt-[0rem] mt-[3rem] text-[1.2rem] tablet:text-[2.3rem] rounded-full h-[120px] w-[120px] tablet:h-[230px]  tablet:w-[230px] text-black uppercase bg-white'>explore</button>
